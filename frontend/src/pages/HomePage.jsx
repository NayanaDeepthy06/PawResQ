...
if (report.injuryDescription.trim().length < 30) {
  setFormError(
    "Please provide a detailed injury description (minimum 30 characters)."
  );
  return;
}
      ...
      <section className="hero-section">
        ...
        <form className="report-form" onSubmit={handleSubmit}>
          ...
          <textarea
            ...
            onChange={handleChange}
            placeholder="Provide detailed information about the animal's injury or condition. Include visible wounds, bleeding, fractures, difficulty moving, unconsciousness, or any other observations that may help rescuers assess the situation."
            rows="5"
            required
          />
          ...
          <p className="field-helper-text">
            ...
            Accurate information helps NGOs and volunteers
            assess rescue priority faster.
          </p>
        ...
        <div className="input-group">
         ...
         {report.location && (
              <div className="location-confirmation-box">
                ...
                <p>
                  <FaMapMarkerAlt />Please verify that this is the exact
                  rescue location.
                </p>
